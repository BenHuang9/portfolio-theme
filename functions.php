...
function portfolio_theme_setup() {
	...
	//Custom Crop Sizes
	add_image_size( 'project-image', 900, 500, true);

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus(
		array(
			'header' => esc_html__( 'Header Menu Location', 'portfolio-theme' ),
...
function portfolio_theme_scripts() {
	...
	wp_enqueue_style( 'font-google', "https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap", array(), null );
	...
	wp_enqueue_script( 'slice-up', get_template_directory_uri() . '/js/slice-up.js', array(), _S_VERSION, true );
}
